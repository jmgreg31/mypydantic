...
class GetRateBasedRuleManagedKeysRequestGetRateBasedRuleManagedKeysPaginateModel(
    BaseModel
):
    rule_id: str = Field(alias="RuleId")
...
class ListActivatedRulesInRuleGroupRequestListActivatedRulesInRuleGroupPaginateModel(
    BaseModel
):
    rule_group_id: Optional[str] = Field(default=None, alias="RuleGroupId")
    pagination_config: Optional[PaginatorConfigModel] = Field(
...
class ListByteMatchSetsRequestListByteMatchSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListGeoMatchSetsRequestListGeoMatchSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )
...
class ListLoggingConfigurationsRequestListLoggingConfigurationsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListRateBasedRulesRequestListRateBasedRulesPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListRegexMatchSetsRequestListRegexMatchSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListRegexPatternSetsRequestListRegexPatternSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )
...
class ListSizeConstraintSetsRequestListSizeConstraintSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListSqlInjectionMatchSetsRequestListSqlInjectionMatchSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListSubscribedRuleGroupsRequestListSubscribedRuleGroupsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListWebACLsRequestListWebACLsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )


class ListXssMatchSetsRequestListXssMatchSetsPaginateModel(BaseModel):
    pagination_config: Optional[PaginatorConfigModel] = Field(
        default=None, alias="PaginationConfig"
    )
